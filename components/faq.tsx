    ...
    <Container size="sm" className={classes.wrapper}>
      ...
      <Accordion variant="separated">
        ...
        <Accordion.Item className={classes.item} value="credit-card">
          <Accordion.Control>Что с размерами миров, и где "Мир ферм"?</Accordion.Control>
          <Accordion.Panel>Для удобства существует разделение. Есть 3 мира ферм, по одному для каждого государства, и главный мир - мир построек!</Accordion.Panel>
        </Accordion.Item>

        <Accordion.Item className={classes.item} value="payment">
          <Accordion.Control>Как работает "Цифровая валюта"?</Accordion.Control>
          <Accordion.Panel>В начале сезоне ВСЕ игроки получают по 200 монет, и игроки спокойно могут использовать её для покупок, продаж, оплат долгов и т.д.</Accordion.Panel>
        </Accordion.Item>
      </Accordion>
    </Container>
  );
